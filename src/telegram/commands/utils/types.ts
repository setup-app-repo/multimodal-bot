...
export type ScreenData = { text: string; keyboard?: InlineKeyboard; parse_mode?: 'HTML' | 'Markdown' };

export type RouteId = 'profile' | 'profile_language' | 'profile_clear' | 'premium' | 'model_connected';
