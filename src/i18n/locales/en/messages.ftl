...
onboarding_promo = **Hi, {$first_name}!** 👋\n\n**I’m SETUP’s AI assistant.**\n\n**Text, photos, or voice**—I turn them into results: from ideas and plans to analysis and finished materials.\n\n🎙 **Voice** → I turn speech into text and highlight what’s important\n📸 **Photos** → I detect what’s shown, describe it, and extract details\n🧑‍💻 **Code** → I help find bugs and suggest improvements\n✉️ **Texts** → I write emails, improve copy, e.t.c\n🧭 **Structure** → I quickly assemble a brief, spec, or action plan\n🔎 **Analytics** → I find facts, spot risks, and give clear takeaways\n🧪 **A/B testing** → I propose multiple headlines, paragraphs, and CTAs\n📊 **Data** → I process tables and files (CSV, PDF, etc.)\n🌍 **Languages** → RU / EN / ES / PT / FR / DE\n\n**✨ Free models are available right away.\n⭐ Premium lowers cost and gives priority.\n🧠 Conversation context is saved—you can switch models without losing history.**\n\n🔥 For serious tasks—**paid AIs: faster, smarter, and even more cost-effective** with Premium.\n\n👉 Tap “**Choose a model**” and let’s go 🚀
...
select_model_legend = <b>0.01 SP</b> — cost per request
    
    🧠 — model intelligence (power level)
    🖼 — can generate images
    🔥 — top model by popularity
    🎙 — can process voice messages
...
model_about_gemini25_pro = <b>Gemini Pro 🌐🔬</b> — Google’s multimodal AI. Balances text, images, and data. Great for analytics, cross‑lingual tasks, and excels at handling voice messages — from speech recognition to analyzing and summarizing content.
...
image_generated_via_footer = ✨ Generated via <a href="{$url}">Multi-Chat bot</a>
image_generated_via_footer_plain = ✨ Generated via Multi-Chat bot
...
autorenew_failed_insufficient_sp =
    <b>⚠️ Failed to renew Premium</b>
    
    🔹 Required: <b>{$required} SP</b>
    🔹 Current balance: <b>{$balance} SP</b>
autorenew_success =
    <b>✅ Auto-renewal successful</b>
