...
onboarding_promo = **Salut, {$first_name}!** 👋\n\n**Assistant IA de SETUP.**\n\n**Texte, photos ou voix** — je transforme en résultats : des idées et plans jusqu’à l’analyse et aux livrables.\n\n🎙 **Voix** → transcrire, résumer, mettre l’essentiel en avant\n📸 **Photos** → identifier, décrire, extraire les détails\n🧑‍💻 **Code** → trouver les bugs et suggérer des améliorations\n✉️ **Textes** → e-mails, amélioration de copy, landing pages et scripts de vente\n🧭 **Structure** → brief, cahier des charges ou plan d’action en vitesse\n🔎 **Analyse** → faits, risques, conclusions claires\n🧪 **A/B test** → variantes de titres, paragraphes et CTA\n📊 **Données** → traiter tableaux et fichiers (CSV, PDF, etc.)\n🌍 **Langues** → RU / EN / ES / PT / FR / DE, voix de marque unifiée\n\n**✨ Modèles gratuits.\n⭐ Premium réduit le coût et donne la priorité.\n🧠 Contexte conservé — changez de modèle sans perdre l’historique.**\n\n🔥 Pour les tâches sérieuses — **IA payantes : plus rapides, plus intelligentes et plus rentables** avec Premium.\n\n👉 « **Choisir le modèle** » — c’est parti 🚀
...
model_about_gemini25_pro = <b>Gemini Pro 🌐🔬</b> — IA multimodale de Google. Équilibre texte, images et données. Pratique pour l’analyse, les tâches multilingues et excelle dans le traitement des messages vocaux — de la reconnaissance vocale à l’analyse et au résumé du contenu.
