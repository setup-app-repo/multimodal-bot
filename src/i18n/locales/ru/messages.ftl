...
model_about_gemini25_pro = <b>Gemini 2.5 Pro 🌐🔬</b> — мультимодальный ИИ от Google. Балансирует работу с текстами, фото и данными. Удобен для аналитики и кросс-языковых задач.
