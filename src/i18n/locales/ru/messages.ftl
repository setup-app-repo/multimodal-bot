...
onboarding_promo = **Привет, {$first_name}!** 👋\n\n**Я — AI-ассистент SETUP.**\n\n**Текст, фото или голос** — превращаю в результат: от идей и планов до аналитики и готовых материалов.\n\n🎙 **Голос** → превращаю в текст, делаю резюме и выделяю главное\n📸 **Фото** → распознаю, что изображено, описываю и вытаскиваю детали\n🧑‍💻 **Код** → помогаю найти ошибки и подсказываю, как сделать лучше\n✉️ **Тексты** → пишу письма, улучшаю тексты, делаю лендинги и скрипты продаж\n🧭 **Структура** → быстро собираю бриф, ТЗ или план действий\n🔎 **Аналитика** → ищу факты, вижу риски и формирую понятные выводы\n🧪 **A/B-тест** → предлагаю разные заголовки, абзацы и варианты CTA\n📊 **Данные** → обрабатываю таблицы и файлы (CSV, PDF и др.)\n🌍 **Языки** → RU / EN / ES / PT / FR / DE, единый голос бренда\n\n**✨ Бесплатные модели доступны сразу.\n⭐ Премиум снижает цену и даёт приоритет.\n🧠 Контекст сохраняется — можно переключаться без потери истории.**\n\n🔥 Для серьёзных задач — **платные ИИ: быстрее, умнее и выгоднее** с Премиум.\n\n👉 Жмите «**Выбрать модель**» — и поехали 🚀
...
model_about_gemini25_pro = <b>Gemini Pro 🌐🔬</b> — мультимодальный ИИ от Google. Балансирует работу с текстами, фото и данными. Удобен для аналитики, кросс-языковых задач и отлично справляется с обработкой голосовых сообщений — от распознавания речи до анализа и резюмирования содержимого.
...
autorenew_failed_insufficient_sp =
    <b>⚠️ Не удалось продлить Премиум</b>
    
    🔹 Требуется: <b>{$required} SP</b>
    🔹 Текущий баланс: <b>{$balance} SP</b>
autorenew_success =
    <b>✅ Успешное автопродление</b>
