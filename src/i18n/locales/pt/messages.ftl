...
onboarding_promo = **Oi, {$first_name}!** 👋\n\n**Sou o assistente de IA da SETUP.**\n\n**Texto, fotos ou voz** — transformo em resultado: de ideias e planos a análises e materiais prontos.\n\n🎙 **Voz** → transformo áudio em texto\n📸 **Fotos** → reconheço o que aparece, descrevo e extraio detalhes\n🧑‍💻 **Código** → ajudo a achar erros e sugiro melhorias\n✉️ **Textos** → escrevo e-mails, melhoro o copy, faço landings e roteiros de vendas\n🧭 **Estrutura** → monto rápido um briefing, especificação ou plano de ação\n🔎 **Analytics** → busco fatos, vejo riscos e entrego conclusões claras\n🧪 **Teste A/B** → proponho títulos, parágrafos e CTAs diferentes\n📊 **Dados** → processo planilhas e arquivos (CSV, PDF etc.)\n🌍 **Idiomas** → RU / EN / ES / PT / FR / DE\n\n**✨ Modelos grátis disponíveis na hora.\n⭐ O Premium reduz o custo e dá prioridade.\n🧠 O contexto fica salvo — você pode trocar de modelo sem perder o histórico.**\n\n🔥 Para tarefas sérias — **IAs pagas: mais rápidas, mais inteligentes e ainda mais econômicas** com o Premium.\n\n👉 Toque em “**Escolher modelo**” e vamos 🚀
...
model_about_gemini25_pro = <b>Gemini Pro 🌐🔬</b> — IA multimodal do Google. Equilibra textos, fotos e dados. Ideal para análises, tarefas multilíngues e se destaca no processamento de mensagens de voz — do reconhecimento de fala à análise e ao resumo do conteúdo.
